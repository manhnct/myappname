...
public class Keyboard {
    ...
    public static final int CODE_VIETNAMESE_SWITCH = -12;
    ...
    public static class Builder<KP extends Params> {
        ...
        private void parseKeyboardAttributes(XmlPullParser parser) {
            ...
            try {
                ...
                // minKeyboardHeight.
                params.mRows = (int) keyboardAttr.getInt(R.styleable.Keyboard_rows, DEFAULT_KEYBOARD_ROWS);
                final float mOH = Math.max(
                        Math.min(keyboardHeight, maxKeyboardHeight), minKeyboardHeight);
                params.mOccupiedHeight = (int)(mOH*params.mRows/DEFAULT_KEYBOARD_ROWS);
                params.mOccupiedWidth = params.mId.mWidth;
                params.mTopPadding = (int)getDimensionOrFraction(keyboardAttr,
                        R.styleable.Keyboard_keyboardTopPadding, (int)mOH, 0);
                params.mBottomPadding = (int)getDimensionOrFraction(keyboardAttr,
                        R.styleable.Keyboard_keyboardBottomPadding, (int)mOH, 0);
                ...
                params.mVerticalGap = (int)getDimensionOrFraction(keyboardAttr,
                        R.styleable.Keyboard_verticalGap, (int)mOH, 0);
                params.mBaseHeight = 
                ...
                params.mDefaultRowHeight = (int)getDimensionOrFraction(keyboardAttr,
                        ...
                        params.mBaseHeight / params.mRows);
        ...
        private boolean parseCaseCondition(XmlPullParser parser) {
            ...
            try {
                ...
                final boolean vietnameseOffMatched = matchBoolean(a,
                        R.styleable.Keyboard_Case_vietnameseOff,
                        id.mVietnamseOff);
                final boolean selected = keyboardLayoutSetElementMatched && modeMatched
                        ...
                        && languageCodeMatched && countryCodeMatched && vietnameseOffMatched;
