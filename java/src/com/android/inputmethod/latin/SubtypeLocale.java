...
public class SubtypeLocale {
    ...
    private static final String RESOURCE_PACKAGE_NAME = "hcmut.cse.ten.quickkeyboardviet";
    ...
    public static int getSubtypeNameId(String localeString, String keyboardLayoutName) {
        if (Build.VERSION.SDK_INT >= /* JELLY_BEAN */ 16 && isExceptionalLocale(localeString)) {
    ...
    public static String getSubtypeDisplayName(final InputMethodSubtype subtype, Resources res) {
        final String replacementString = (Build.VERSION.SDK_INT >= /* JELLY_BEAN */ 16
