...
public class KeyboardId {
    ...
    public final boolean mVietnamseOff;
    ...
    public KeyboardId(int elementId, InputMethodSubtype subtype, int orientation, int width,
            ...
            boolean hasShortcutKey, boolean languageSwitchKeyEnabled, boolean vietnameseOff) {
        mSubtype = subtype;
    ...
    private boolean equals(KeyboardId other) {
        ...
        return other.mOrientation == mOrientation
                ...
                && other.mVietnamseOff == mVietnamseOff;
    }
