...
public class KeyboardSwitcher implements KeyboardState.SwitchActions {
    ...
    private static final KeyboardTheme[] KEYBOARD_THEMES = {
        ...
        new KeyboardTheme("IceCreamSandwich (Big keys)", 10, R.style.KeyboardTheme_IceCreamSandwich_BigKeys),
    ...
    public void loadKeyboard(EditorInfo editorInfo, SettingsValues settingsValues) {
        ...
        builder.setOptions(
                ...
                settingsValues.mVietnameseOff);
        if( ! "vi".equals(mSubtypeSwitcher.getCurrentSubtype().getLocale()) ) {
        	mKeyboardLayoutSet = builder.build();
        }
        else if(("vi".equals(mSubtypeSwitcher.getCurrentSubtype().getLocale())&& settingsValues.mVietnameseInputMethod.equals(VietnameseSpellChecker.INPUT_METHOD_VNI) ))
        {
        	mKeyboardLayoutSet = builder.build_vni();
        }
        else
        {
        	mKeyboardLayoutSet = builder.build();
