...
public class Settings extends InputMethodSettingsFragment
    ...
    //vietnamese
    private static final String PREF_KEYBOARD_THEME_KEY = "pref_keyboard_layout";
    private static final String PREF_VIETNAMESE_INPUT_METHOD_KEY = "vietnamese_input_method";
    private boolean mServiceNeedsRestart = false;
    private ListPreference mKeyboardThemePreference;
    private ListPreference mVietnameseInputMethodPreference;
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (includeOtherImesInLanguageSwitchList != null) {
        ...
        mVietnameseInputMethodPreference = (ListPreference)findPreference(PREF_VIETNAMESE_INPUT_METHOD_KEY);
        if (mVietnameseInputMethodPreference != null) {
        	updateVietnameseInputMethodSummary(prefs, res);
        }    
    }
    ...
    public void onSharedPreferenceChanged(SharedPreferences prefs, String key) {
        ...
        } else if (key.equals(PREF_VIETNAMESE_INPUT_METHOD_KEY)) {        	
        	mServiceNeedsRestart = true;
        }
        ensureConsistencyOfAutoCorrectionSettings();
        updateVoiceModeSummary();
        ...
        updateVietnameseInputMethodSummary(prefs, getResources());
    }
    ...
    private void updateVietnameseInputMethodSummary(SharedPreferences sp, Resources res) {
    	if (mVietnameseInputMethodPreference != null) {
    		mVietnameseInputMethodPreference.setSummary(
                getResources().getStringArray(R.array.vietnamese_input_methods)
                [mVietnameseInputMethodPreference.findIndexOfValue(mVietnameseInputMethodPreference.getValue())]);
    	}
    }
}
